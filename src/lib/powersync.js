/**
 * powersync.js — PowerSync Database Instance
 * enableMultiTabs: false → يعمل بدون SharedArrayBuffer (GitHub Pages)
 */
import {
  PowerSyncDatabase,
  column,
...
const families = new Table({
  ...
  tent: column.text, original_address: column.text, notes: column.text,
